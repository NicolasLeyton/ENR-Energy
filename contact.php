...
$destinataire = 'contact@enr-energy.fr';
...
if ($envoye) {
    ...
    $corps_client .= "Nous avons bien reçu votre demande concernant : {$projet}.\n\n";
    $corps_client .= "Notre équipe va l'étudier et reviendra vers vous.\n\n";
    $corps_client .= "Si votre demande est urgente, le plus simple est de nous appeler\n";
    $corps_client .= "directement pendant nos horaires d'ouverture (lun–jeu 7h–18h, ven 7h–17h).\n\n";
    $corps_client .= "Pour nous joindre directement :\n";
    $corps_client .= "  📞 04 76 40 56 69 / 06 46 42 10 22\n";
    $corps_client .= "  ✉️  contact@enr-energy.fr\n\n";
